...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Only Admin Can Run This Command S4 SARCASTIC."
    ...
    if user_id in admin_id:
        ...
        if len(command) > 1:
            ...
            if user_to_remove in allowed_user_ids:
                ...
                response = f"User {user_to_remove} removed successfully by SARCASTIC BOY."
            else:
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in bgmi_cooldown and (datetime.datetime.now() - bgmi_cooldown[user_id]).seconds < 300:
                response = "You Are On Cooldown. Please Wait 0min Before Running The /attack2 Command Again by STORM BOT @https://t.me/bgmisellingbuying."
                bot.reply_to(message, response)
                return
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            response = "Usage :- /bgmi <target> <port> <time>\nBy S4 SARCASTIC"  # Updated command syntax
    else:
...
def show_help(message):
 ...
 /attack2 : Method For Bgmi Servers. 
